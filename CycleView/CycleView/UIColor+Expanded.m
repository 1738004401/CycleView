...
//  AlcedoTabBar
//
//  Created by weiweiweiwei on 16/1/9.
//  Copyright © 2016年 com.haofengsoft. All rights reserved.
//
...
-(UIColor *)colorByLighteningToRed:(CGFloat)red green:(CGFloat)green blue:(CGFloat)blue alpha:(CGFloat)alpha:(CGFloat)red green:(CGFloat)green blue:(CGFloat)blue alpha:(CGFloat)alpha{
    NSAssert(self.canProvideRGBComponents, @"Must be a RGB color to use arithmatic operations");
...
+(UIColor *)randomColor{
    return [UIColor colorWithRed:(arc4random()%256/256.0f) green:(arc4random()%256/256.0f) blue:(arc4random()%256/256.0f) alpha:1.0f];
}
